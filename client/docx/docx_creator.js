...
const DOCX_CONFIG = {
  ...
  header: { logoWidth: 672, logoHeight: 120, afterLogoSpacing: 120, topLabelsAfterSpacing: 80, receiverIndentLeft: 7200, rightTabPosition: 10000 },
...
export const docxCreator = (requestData, selectedSigners = []) => {
  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      children: [
        new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 0, after: 0 }, children: [new TextRun({ text: `${DOCX_CONFIG.requestNumber.prefix}${requestNumber}`, bold: false, size: 16 })] }),
